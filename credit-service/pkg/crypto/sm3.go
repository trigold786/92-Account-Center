...
func NewSM3() *SM3 {
	return &SM3{
		digest: []uint32{0x7380166f, 0x4914b2b9, 0x172442d7, 0xda8a0600,
			0xa96f30bc, 0x163138aa, 0xe38dee4d, 0xb0fb0e4e},
	}
}
...
func (s *SM3) Sum(in []byte) []byte {
	result := sm3Compute(s.message)
	return append(in, result[:]...)
}

func (s *SM3) Reset() {
	s.message = nil
	s.digest = []uint32{0x7380166f, 0x4914b2b9, 0x172442d7, 0xda8a0600,
		0xa96f30bc, 0x163138aa, 0xe38dee4d, 0xb0fb0e4e}
}
