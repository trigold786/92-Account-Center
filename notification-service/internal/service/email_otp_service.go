...
func (s *otpEmailService) SendOTP(ctx context.Context, email string) (*model.OTPResponse, error) {
...
func (s *otpEmailService) VerifyOTP(ctx context.Context, email, code string) (bool, error) {
	otpKey := otpKeyPrefix + email
...
func (s *otpEmailService) VerifyMagicLink(ctx context.Context, tokenString string) (string, error) {
...
func (s *otpEmailService) SendEmail(ctx context.Context, to, subject, content string) error {
