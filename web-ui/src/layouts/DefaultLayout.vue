  ...
  <el-container style="min-height: 100vh">
    <el-aside width="220px" style="background: #161B22; border-right: 1px solid #30363D">
      ...
      <el-menu :router="true" background-color="#161B22" text-color="#8B949E" active-text-color="#6C63FF" style="border: none">
        ...
        <el-menu-item index="/account"><el-icon><User /></el-icon>我的账户</el-menu-item>
        <el-menu-item index="/credits"><el-icon><Coin /></el-icon>积分</el-menu-item>
        <el-menu-item index="/subscriptions"><el-icon><Ticket /></el-icon>订阅</el-menu-item>
        <el-menu-item index="/referral"><el-icon><Share /></el-icon>推荐</el-menu-item>
        <el-menu-item index="/devices"><el-icon><Monitor /></el-icon>设备</el-menu-item>
        <el-menu-item index="/admin"><el-icon><Setting /></el-icon>管理后台</el-menu-item>
      </el-menu>
